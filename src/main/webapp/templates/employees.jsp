...
<html lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      href="${pageContext.request.contextPath}/static/css/employeesmenu.css"
    />
      ...
      <div class="search-wrapper">
        ...
        <div class="bot-gap">
          ...
          <input
            ...
            placeholder="Insert employee's lastname"
            autofocus
          />
          <br /><br />
          <button id="btn" class="search-btn rounded color-btn" type="button">
            Search
          </button>
          <!-- </form> -->
        </div>
